    ...
    >
      <div className={`grid lg:grid-cols-2 gap-16 items-center ${
        ...
        <div className={`space-y-6 ${project.reverse ? 'lg:col-start-1' : ''}`}>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-gray-900 dark:text-white text-lg">Technologies Used</h4>
...
const ProjectSection = () => {
  const projects: Project[] = [
    {
      title: 'Animeverse',
      description: 'A comprehensive web application for managing anime watchlists. Features include personalized recommendations, progress tracking, community reviews, and a responsive design that works seamlessly across all devices.',
